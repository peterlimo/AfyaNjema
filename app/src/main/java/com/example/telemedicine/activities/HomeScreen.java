...
import com.example.telemedicine.fragments_home_screen.NotifiCationList;
...
import com.example.telemedicine.fragments_home_screen.SheduleFragment;
import com.example.telemedicine.fragments_home_screen.profile_fragment;
...
//                    badgeDrawable.setVisible(false);
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.FL_fragment_container, new NotifiCationList()).commit();
//                }
//                else
//                {
//                    getSupportFragmentManager().beginTransaction()
...
//                }
            ...
            case R.id.profile:
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.FL_fragment_container, new profile_fragment()).commit();
                break;
            case R.id.schedule:
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.FL_fragment_container, new SheduleFragment()).commit();
                break;
        }
        return true;
    }
