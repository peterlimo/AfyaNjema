        ...
        implements View.OnClickListener, OnRegListener
{
    ...
    private EditText fullName, birthday, email, phone, location, username, password;
        ...
        switch (v.getId())
        {
            case (R.id.btn_next):
                ...
                if (allFieldsFilled())
                {
                    ...
                    StorageReference ref=storage.getReference("profile");
            if (selectedImage!=null) {
            ref.putFile(selectedImage)
            .addOnSuccessListener(taskSnapshot -> {
                Toast.makeText(SignupScreen.this, "Profile added successfully", Toast.LENGTH_SHORT).show();
           ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
               @Override
               public void onSuccess(Uri uri) {
                   FirebaseHelper helper=new FirebaseHelper(SignupScreen.this);
                   com.example.telemedicine.data.User user=new com.example.telemedicine.data.User(fullName.getText().toString(),birthday.getText().toString(),email.getText().toString(),phone.getText().toString(),location.getText().toString(),username.getText().toString(),password.getText().toString(),uri.toString());
                   helper.saveUser(user,email.getText().toString().trim().toLowerCase());
               }
           });
            })
            .addOnFailureListener(e -> Toast.makeText(SignupScreen.this, "Failed to add profile image!!", Toast.LENGTH_SHORT).show());
}
else {
